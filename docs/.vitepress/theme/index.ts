...
const AXIOM: Record<string, string> = {
  'zh-CN':
    ...
    'AxiomCode 把这种结构带入 AI 时代：一个统一的 endpoint，让一切调用从此<strong>恒等</strong>。',
  en:
    'In Euclid’s geometry, an <strong>axiom</strong> is a proposition accepted as true without proof — ' +
    'every proof begins there. AxiomCode brings that structure into the age of AI: one unified endpoint, ' +
